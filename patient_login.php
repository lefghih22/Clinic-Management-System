...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($patient_email) && !empty($password)) {

        $sql = "SELECT * FROM patient_details WHERE patient_email = '$patient_email'";
        ...
        $error = "Patient Email and Password cannot be empty.";
    }
}
?>
        ...
        <div class="form-container">
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="patient_email" id="patient_email" class="form-control" required>
                </div>
                <div class="mb-3">
